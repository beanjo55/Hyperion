...
import {manager as MGM, QuoteConfig as qc, GoodbyeConfig as gc, LogEvent as le, WelcomeConfig as wc, AutoroleConfig as arc, SocialConfig as sc, RRConfig as rrc, RankConfig as rc, TagConfig as tc, LoggingConfig as lc, StarboardConfig as sbc, ModuleConfig as mc, ModConfig as modc, CommandConfig as cc} from "./Structures/MongoGuildManager";
import {manager as MUM} from "./Structures/MongoUserManager";
import {manager as MMLM} from "./Structures/MongoModLogManager";
import {GlobalType, GuildType, GuilduserType, UserType, V2Type} from "../main";
import {default as MGUM} from "./Structures/MongoGuildUserManager";
...
export interface IUtils{
    ...
    banResolver(search: string, members: Collection<Member>, Hyperion: V2Type): Promise<Member | User | undefined>;
...
export type GlobalConfig = GlobalType;
...
export type levelUpdateResult = {data: GuilduserType | UserType; lvlUp: boolean}
