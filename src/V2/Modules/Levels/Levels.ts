...
import {LevelsConfig} from "../../Structures/MongoGuildManager";
...
class Levels extends Module{
    ...
    async messageCreate(...args: [Message]): Promise<void | undefined>{
        const msg = args[0];
    ...
    async expRoles(guild: Guild, msg: Message, data: UserType | GuilduserType, global = false): Promise<void>{
